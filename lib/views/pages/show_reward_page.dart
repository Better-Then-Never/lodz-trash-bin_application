...
class ShowRewardPage extends StatefulWidget {
  ...
  @override
  State<ShowRewardPage> createState() => _ShowRewardPageState();
}

class _ShowRewardPageState extends State<ShowRewardPage> {
  @override
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(widget.isAfterPurchase ? 'Sukces!' : 'Twój rabat!'),
